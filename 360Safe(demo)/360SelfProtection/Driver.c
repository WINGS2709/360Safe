...
BOOLEAN NTAPI Safe_Initialize_Data()
{
	...
	g_ObjectType = NULL;
	g_SystemHotpatchInformationFlag = 1;
...
{
	//Safe_Run_SetFilterSwitchFunction(gFilterFun_Rule_table_head_Temp, ZwWriteFile_FilterIndex, (ULONG)Fake_ZwWriteFile);
	//Safe_Run_SetFilterSwitchFunction(gFilterFun_Rule_table_head_Temp, CreateProcessNotifyRoutine_FilterIndex, (ULONG)Fake_CreateProcessNotifyRoutine);
	//Safe_Run_SetFilterSwitchFunction(gFilterFun_Rule_table_head_Temp, ZwOpenFile_FilterIndex, (ULONG)Fake_ZwOpenFile);
	//Safe_Run_SetFilterSwitchFunction(gFilterFun_Rule_table_head_Temp, ZwCreateFile_FilterIndex, (ULONG)Fake_ZwCreateFile);
	//Safe_Run_SetFilterSwitchFunction(gFilterFun_Rule_table_head_Temp, ZwCreateSection_FilterIndex, (ULONG)Fake_ZwCreateSection);
	//Safe_Run_SetFilterSwitchFunction(gFilterFun_Rule_table_head_Temp, ZwDeleteFile_FilterIndex, (ULONG)Fake_ZwDeleteFile);
	//Safe_Run_SetFilterSwitchFunction(gFilterFun_Rule_table_head_Temp, ZwCreateProcess_FilterIndex, (ULONG)Fake_ZwCreateProcess);
	//Safe_Run_SetFilterSwitchFunction(gFilterFun_Rule_table_head_Temp, ZwCreateProcess_FilterIndex, (ULONG)Fake_ZwCreateProcessEx);
	//Safe_Run_SetFilterSwitchFunction(gFilterFun_Rule_table_head_Temp, ZwOpenKey_FilterIndex, (ULONG)Fake_ZwOpenKey);
	//Safe_Run_SetFilterSwitchFunction(gFilterFun_Rule_table_head_Temp, ZwUnmapViewOfSection_FilterIndex, (ULONG)Fake_ZwUnmapViewOfSection);
	//Safe_Run_SetFilterSwitchFunction(gFilterFun_Rule_table_head_Temp, ZwUnmapViewOfSectionIndex_Win8_Win10_FilterIndex, (ULONG)Fake_ZwUnmapViewOfSection);
	//Safe_Run_SetFilterSwitchFunction(gFilterFun_Rule_table_head_Temp, ZwSuspendProcess_FilterIndex, (ULONG)Fake_ZwSuspendProcess);
	//Safe_Run_SetFilterSwitchFunction(gFilterFun_Rule_table_head_Temp, ZwSuspendThread_FilterIndex, (ULONG)Fake_ZwSuspendThread);
	//Safe_Run_SetFilterSwitchFunction(gFilterFun_Rule_table_head_Temp, ZwAllocateVirtualMemory_FilterIndex, (ULONG)Fake_ZwAllocateVirtualMemory);
	//Safe_Run_SetFilterSwitchFunction(gFilterFun_Rule_table_head_Temp, ZwOpenProcess_FilterIndex, (ULONG)Fake_ZwOpenProcess);
	//Safe_Run_SetFilterSwitchFunction(gFilterFun_Rule_table_head_Temp, ZwWriteVirtualMemory_FilterIndex, (ULONG)Fake_ZwWriteVirtualMemory);
	//Safe_Run_SetFilterSwitchFunction(gFilterFun_Rule_table_head_Temp, ZwCreateThread_FilterIndex, (ULONG)Fake_ZwCreateThread);
	//Safe_Run_SetFilterSwitchFunction(gFilterFun_Rule_table_head_Temp, ZwSetSystemTime_FilterIndex, (ULONG)Fake_ZwSetSystemTime);
	//Safe_Run_SetFilterSwitchFunction(gFilterFun_Rule_table_head_Temp, ZwCreateSymbolicLinkObject_FilterIndex, (ULONG)Fake_ZwCreateSymbolicLinkObject);
	//Safe_Run_SetFilterSwitchFunction(gFilterFun_Rule_table_head_Temp, ZwGetNextThread_FilterIndex, (ULONG)Fake_ZwGetNextThread);
	//Safe_Run_SetFilterSwitchFunction(gFilterFun_Rule_table_head_Temp, ZwGetNextProcess_FilterIndex, (ULONG)Fake_ZwGetNextProcess);
	//Safe_Run_SetFilterSwitchFunction(gFilterFun_Rule_table_head_Temp, ZwOpenMutant_FilterIndex, (ULONG)Fake_ZwOpenMutant);
	//Safe_Run_SetFilterSwitchFunction(gFilterFun_Rule_table_head_Temp, ZwOpenThread_FilterIndex, (ULONG)Fake_ZwOpenThread);
	//Safe_Run_SetFilterSwitchFunction(gFilterFun_Rule_table_head_Temp, ess_FilterIndex, (ULOZwOpenSection_FilterIndex, (ULONG)Fake_ZwOpenSection);
	//Safe_Run_SetFilterSwitchFunction(gFilterFun_Rule_table_head_Temp, ZwTerminateProcNG)Fake_ZwTerminateProcess);
	//Safe_Run_SetFilterSwitchFunction(gFilterFun_Rule_table_head_Temp, ZwZwDuplicateObject_FilterIndex, (ULONG)Fake_ZwDuplicateObject);
	//Safe_Run_SetFilterSwitchFunction(gFilterFun_Rule_table_head_Temp, ZwMakeTemporaryObject_FilterIndex, (ULONG)Fake_ZwMakeTemporaryObject);
	//Safe_Run_SetFilterSwitchFunction(gFilterFun_Rule_table_head_Temp, ZwEnumerateValueKey_FilterIndex, (ULONG)Fake_ZwEnumerateValueKey);
	Safe_Run_SetFilterSwitchFunction(gFilterFun_Rule_table_head_Temp, ZwAlpcSendWaitReceivePort_FilterIndex, (ULONG)Fake_ZwAlpcSendWaitReceivePort);
	Safe_Run_SetFilterSwitchFunction(gFilterFun_Rule_table_head_Temp, ZwLoad_Un_Driver_FilterIndex, (ULONG)Fake_ZwLoadDriver);
	Safe_Run_SetFilterSwitchFunction(gFilterFun_Rule_table_head_Temp, ClientLoadLibrary_FilterIndex, (ULONG)Fake_ClientLoadLibrary);			//拦截DLL注入的
	Safe_Run_SetFilterSwitchFunction(gFilterFun_Rule_table_head_Temp, ZwSetSystemInformation_FilterIndex, (ULONG)Fake_ZwSetSystemInformation);	//加载驱动XP生效
	return TRUE;
}
...
VOID NTAPI Safe_Initialize_SetFilterRule(PDEVICE_OBJECT pHookPortDeviceObject)
{
	...
	{
		//Safe_Run_SetFilterRule(gFilterFun_Rule_table_head_Temp, ZwWriteFile_FilterIndex, 1);
		//Safe_Run_SetFilterRule(gFilterFun_Rule_table_head_Temp, CreateProcessNotifyRoutine_FilterIndex, 1);
		//Safe_Run_SetFilterRule(gFilterFun_Rule_table_head_Temp, ZwOpenFile_FilterIndex, 1);
		//Safe_Run_SetFilterRule(gFilterFun_Rule_table_head_Temp, ZwCreateFile_FilterIndex, 1);
		//Safe_Run_SetFilterRule(gFilterFun_Rule_table_head_Temp, ZwCreateSection_FilterIndex, 1);
		//Safe_Run_SetFilterRule(gFilterFun_Rule_table_head_Temp, ZwDeleteFile_FilterIndex, 1);
		//Safe_Run_SetFilterRule(gFilterFun_Rule_table_head_Temp, ZwCreateProcess_FilterIndex, 1);
		//Safe_Run_SetFilterRule(gFilterFun_Rule_table_head_Temp, ZwCreateProcessEx_FilterIndex, 1);
		//Safe_Run_SetFilterRule(gFilterFun_Rule_table_head_Temp, ZwOpenKey_FilterIndex, 1);
		//Safe_Run_SetFilterRule(gFilterFun_Rule_table_head_Temp, ZwUnmapViewOfSection_FilterIndex, 1);					
		//Safe_Run_SetFilterRule(gFilterFun_Rule_table_head_Temp, ZwUnmapViewOfSectionIndex_Win8_Win10_FilterIndex, 1);
		//Safe_Run_SetFilterRule(gFilterFun_Rule_table_head_Temp, ZwSuspendProcess_FilterIndex, 1);
		//Safe_Run_SetFilterRule(gFilterFun_Rule_table_head_Temp, ZwSuspendThread_FilterIndex, 1);
		//Safe_Run_SetFilterRule(gFilterFun_Rule_table_head_Temp, ZwAllocateVirtualMemory_FilterIndex, 1);
		//Safe_Run_SetFilterRule(gFilterFun_Rule_table_head_Temp, ZwOpenProcess_FilterIndex, 1);
		//Safe_Run_SetFilterRule(gFilterFun_Rule_table_head_Temp, ZwWriteVirtualMemory_FilterIndex, 1);
		//Safe_Run_SetFilterRule(gFilterFun_Rule_table_head_Temp, ZwCreateThread_FilterIndex, 1);
		//Safe_Run_SetFilterRule(gFilterFun_Rule_table_head_Temp, ZwSetSystemTime_FilterIndex, 1);
		//Safe_Run_SetFilterRule(gFilterFun_Rule_table_head_Temp, ZwCreateSymbolicLinkObject_FilterIndex, 1);
		//Safe_Run_SetFilterRule(gFilterFun_Rule_table_head_Temp, ZwGetNextThread_FilterIndex, 1);
		//Safe_Run_SetFilterRule(gFilterFun_Rule_table_head_Temp, ZwGetNextProcess_FilterIndex, 1);
		//Safe_Run_SetFilterRule(gFilterFun_Rule_table_head_Temp, ZwOpenMutant_FilterIndex, 1);
		//Safe_Run_SetFilterRule(gFilterFun_Rule_table_head_Temp, ZwOpenThread_FilterIndex, 1);
		//Safe_Run_SetFilterRule(gFilterFun_Rule_table_head_Temp, ZwOpenSection_FilterIndex, 1);
		//Safe_Run_SetFilterRule(gFilterFun_Rule_table_head_Temp, ZwTerminateProcess_FilterIndex, 1);
		//Safe_Run_SetFilterRule(gFilterFun_Rule_table_head_Temp, ZwZwDuplicateObject_FilterIndex, 1);
		//Safe_Run_SetFilterRule(gFilterFun_Rule_table_head_Temp, ZwMakeTemporaryObject_FilterIndex, 1);
		//Safe_Run_SetFilterRule(gFilterFun_Rule_table_head_Temp, ZwEnumerateValueKey_FilterIndex, 1);
		Safe_Run_SetFilterRule(gFilterFun_Rule_table_head_Temp, ZwAlpcSendWaitReceivePort_FilterIndex, 1);  
		Safe_Run_SetFilterRule(gFilterFun_Rule_table_head_Temp, ZwLoad_Un_Driver_FilterIndex, 1);			//拦截驱动
		Safe_Run_SetFilterRule(gFilterFun_Rule_table_head_Temp, ClientLoadLibrary_FilterIndex, 1);			//全局钩子拦截DLL注入
		Safe_Run_SetFilterRule(gFilterFun_Rule_table_head_Temp, ZwSetSystemInformation_FilterIndex, 1);		//加载驱动XP生效
	...
	)
{
	...
	DriverObject->MajorFunction[IRP_MJ_SHUTDOWN] = Safe_Shutdown;				//重启重置注册表信息，防止被删除
	...
	if (g_ThreadID_Table && g_dynData)
	{
		...
		if (pHookPortDeviceObject->DeviceExtension &&
			...
			(gFilterFun_Rule_table_head_Temp = HookPort_AllocFilterRuleTable(3)) != 0) &&			//获取HookPort.sys生成的旧规则地址
			...
			)
		{
			...
			//设置开关启用
			gFilterFun_Rule_table_head_Temp->IsFilterFunFilledReady = 1;
			//清理垃圾
